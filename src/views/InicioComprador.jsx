...
const InicioComprador = () => {
  ...
  useEffect(() => {
    const cargarDatos = async () => {
      const catCache = sessionStorage.getItem(
      ...
      if (catCache) {
        try {
          ...
          console.error(
            "Error leyendo categorías del cache:",
            error
          );
        }
      }
      ...
      try {
        const [prodResponse, catResponse] =
          await Promise.all([
            supabase
              .from("productos")
              .select(
            ...
            <Col lg={6}>
              ...
              <div className="inicio-hero-content">
                ...
                <p className="inicio-hero-description">
                  ...
                  Explora productos únicos de
                  vendedores locales, encuentra lo
                  que necesitas y disfruta de una
        ...
        <Container>
          ...
          <div className="inicio-section-heading">
            ...
            <div>
              ...
              <span className="inicio-section-kicker">
                EXPLORA
              </span>
              ...
              <p>
                Navega por nuestras categorías y
                ...
                (cat, index) => (
                  ...
                  >
                    ...
                    <Card
                      ...
                      onClick={() =>
                        navigate(
                          `/catalogo?categoria=${cat.id_categoria}`
                        )
                      }
                    >
        ...
        <Container>
          ...
          <div className="inicio-section-heading">
            ...
            <div>
              ...
              <p>
                Descubre algunos de los productos
                más recientes del marketplace.
              </p>
                  ...
                  >
                    ...
                    <div className="inicio-product-wrapper">
                      ...
                      <TarjetaCatalogo
                        ...
                        abrirModalDetalles={() =>
                          navigate(
                            `/catalogo?prod=${prod.id_producto}`
                          )
                        }
                        abrirModalContacto={() =>
                          navigate("/mensajes")
              ...
              <Col md={4}>
                ...
                <div className="inicio-benefit-card">
                  ...
                  <div>
                    ...
                    <p>
                      Recibe tus productos de
                      forma rápida y conveniente.
                    </p>
        ...
        <Container>
          ...
          <div className="inicio-final-cta-content">
            ...
            <p>
              ...
              productos que podrían convertirse en
