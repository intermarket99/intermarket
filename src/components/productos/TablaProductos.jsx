...
const TablaProductos = ({
  ...
  const obtenerInfoOferta = (producto) => {
    ...
    const base =
      precioOriginal > 0 ? precioOriginal : parseFloat(producto.precio_compra || 0);
        ...
        {productos.map((producto) => {
          ...
          return (
            <tr key={producto.id_producto}>
              ...
              <td className="fw-bold">{producto.nombre_producto}</td>
              <td
              ...
              <td>{producto.tiendas?.nombre_tienda || "—"}</td>
              <td className="text-end">{formatearPrecio(producto.precio_compra)}</td>
                ...
                {infoOferta.esOferta ? (
                  <div className="d-flex flex-column align-items-center">
                    ...
                    <small className="text-success fw-semibold">
                      Ahorra {formatearPrecio(infoOferta.ahorro)}
                    </small>
                  </div>
                ) : (
